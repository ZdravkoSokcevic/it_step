<?php
    ...
    $lastWorker=Work::getLastId()->fetch(PDO::FETCH_OBJ);
    $workerr=Work::findById($lastWorker->id);
...
<body>
    ...
    <div class="container">
        ...
        <div class="card-form">
            ...
            <form name="worker" method="POST" target="../controller/insert.php" action="../controller/insert.php" enctype="multipart/form-data">
        ...
        <img src="<?php echo $workerr->picture?>" alt="slika">
    </div>
</body>
</html>